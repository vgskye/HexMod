...
public class PatternTooltipComponent implements ClientTooltipComponent {
	...
	public PatternTooltipComponent(PatternTooltip tt) {
		...
		this.zappyPoints =
				RenderLib.makeZappy(
						...
						RenderLib.DEFAULT_LAST_SEGMENT_LEN_PROP,
						0.0);
	...
	public void renderImage(Font font, int mouseX, int mouseY, GuiGraphics graphics) {
		...
		RenderLib.drawLineSeq(mat, this.zappyPoints, 6f, 0, outer, outer);
		RenderLib.drawLineSeq(mat, this.zappyPoints, 6f * 0.4f, 0, innerDark, innerLight);
